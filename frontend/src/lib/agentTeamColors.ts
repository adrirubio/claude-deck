...
const COLOR_CLASSES: Record<TeamSlotUIColor, TeamSlotColorClasses> = {
  blue: {
    ...
    dot: 'bg-blue-400',
    terminalBar: 'border-blue-700/80 dark:border-blue-500/60',
    terminalWrapper: 'bg-blue-50/80 ring-1 ring-inset ring-blue-700/20 dark:bg-blue-950/20 dark:ring-0',
  },
  purple: {
    card: 'border-l-4 border-l-purple-500 bg-purple-500/5',
    badge: 'border-purple-500/50 bg-purple-500/10 text-purple-300',
    dot: 'bg-purple-400',
    terminalBar: 'border-purple-700/80 dark:border-purple-500/60',
    terminalWrapper: 'bg-purple-50/80 ring-1 ring-inset ring-purple-700/20 dark:bg-purple-950/20 dark:ring-0',
  },
  green: {
    card: 'border-l-4 border-l-emerald-500 bg-emerald-500/5',
    badge: 'border-emerald-500/50 bg-emerald-500/10 text-emerald-300',
    dot: 'bg-emerald-400',
    terminalBar: 'border-emerald-700/80 dark:border-emerald-500/60',
    terminalWrapper: 'bg-emerald-50/80 ring-1 ring-inset ring-emerald-700/25 dark:bg-emerald-950/20 dark:ring-0',
  },
  amber: {
    card: 'border-l-4 border-l-amber-500 bg-amber-500/5',
    badge: 'border-amber-500/50 bg-amber-500/10 text-amber-300',
    dot: 'bg-amber-400',
    terminalBar: 'border-amber-700/80 dark:border-amber-500/60',
    terminalWrapper: 'bg-amber-50/80 ring-1 ring-inset ring-amber-700/25 dark:bg-amber-950/20 dark:ring-0',
  },
  red: {
    card: 'border-l-4 border-l-red-500 bg-red-500/5',
    badge: 'border-red-500/50 bg-red-500/10 text-red-300',
    dot: 'bg-red-400',
    terminalBar: 'border-red-700/80 dark:border-red-500/60',
    terminalWrapper: 'bg-red-50/80 ring-1 ring-inset ring-red-700/20 dark:bg-red-950/20 dark:ring-0',
  },
  cyan: {
    card: 'border-l-4 border-l-cyan-500 bg-cyan-500/5',
    badge: 'border-cyan-500/50 bg-cyan-500/10 text-cyan-300',
    dot: 'bg-cyan-400',
    terminalBar: 'border-cyan-700/80 dark:border-cyan-500/60',
    terminalWrapper: 'bg-cyan-50/80 ring-1 ring-inset ring-cyan-700/25 dark:bg-cyan-950/20 dark:ring-0',
  },
  slate: {
    card: 'border-l-4 border-l-slate-500 bg-slate-500/5',
    badge: 'border-slate-500/50 bg-slate-500/10 text-slate-300',
    dot: 'bg-slate-400',
    terminalBar: 'border-slate-700/80 dark:border-slate-500/60',
    terminalWrapper: 'bg-slate-100/80 ring-1 ring-inset ring-slate-700/25 dark:bg-slate-950/20 dark:ring-0',
  },
}
