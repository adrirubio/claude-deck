...
const COLOR_CLASSES: Record<TeamSlotUIColor, TeamSlotColorClasses> = {
  blue: {
    ...
    dot: 'bg-blue-400',
    terminalBar: 'border-blue-500/30 bg-blue-950/40',
  ...
  purple: {
    ...
    dot: 'bg-purple-400',
    terminalBar: 'border-purple-500/30 bg-purple-950/40',
  ...
  green: {
    ...
    dot: 'bg-emerald-400',
    terminalBar: 'border-emerald-500/30 bg-emerald-950/40',
  ...
  amber: {
    ...
    dot: 'bg-amber-400',
    terminalBar: 'border-amber-500/30 bg-amber-950/40',
  ...
  red: {
    ...
    dot: 'bg-red-400',
    terminalBar: 'border-red-500/30 bg-red-950/40',
  ...
  cyan: {
    ...
    dot: 'bg-cyan-400',
    terminalBar: 'border-cyan-500/30 bg-cyan-950/40',
  ...
  slate: {
    ...
    dot: 'bg-slate-400',
    terminalBar: 'border-slate-500/30 bg-slate-900/60',
